...
class gsp_bottlesOnBottles_layoutsmain_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('render','g',22,['template':("/common/topbar")],-1)
printHtmlPart(1)
...
public static final long LAST_MODIFIED = 1397424889616L
