...
class gsp_bottlesOnBottles_categoryshow_gsp extends GroovyPage {
...
printHtmlPart(18)
invokeTag('message','g',37,['code':("category.description.label"),'default':("Description")],-1)
printHtmlPart(19)
invokeTag('fieldValue','g',39,['bean':(categoryInstance),'field':("description")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (categoryInstance?.image)) {
printHtmlPart(20)
invokeTag('message','g',46,['code':("category.image.label"),'default':("Image")],-1)
printHtmlPart(21)
invokeTag('fieldValue','g',48,['bean':(categoryInstance),'field':("image")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (categoryInstance?.products)) {
printHtmlPart(22)
invokeTag('message','g',55,['code':("category.products.label"),'default':("Products")],-1)
printHtmlPart(23)
...
invokeTag('link','g',58,['controller':("product"),'action':("show"),'id':(p.id)],4)
printHtmlPart(25)
}
printHtmlPart(26)
}
...
public static final long LAST_MODIFIED = 1397420083479L
