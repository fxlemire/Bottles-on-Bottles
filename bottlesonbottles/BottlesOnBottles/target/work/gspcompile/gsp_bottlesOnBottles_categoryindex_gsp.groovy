...
class gsp_bottlesOnBottles_categoryindex_gsp extends GroovyPage {
...
printHtmlPart(13)
invokeTag('sortableColumn','g',29,['property':("description"),'title':(message(code: 'category.description.label', default: 'Description'))],-1)
printHtmlPart(13)
invokeTag('sortableColumn','g',31,['property':("image"),'title':(message(code: 'category.image.label', default: 'Image'))],-1)
printHtmlPart(14)
loop:{
int i = 0
...
printHtmlPart(17)
expressionOut.print(fieldValue(bean: categoryInstance, field: "image"))
printHtmlPart(18)
i++
}
}
...
public static final long LAST_MODIFIED = 1397420083478L
