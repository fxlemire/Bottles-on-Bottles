...
class gsp_bottlesOnBottles_productcreate_gsp extends GroovyPage {
...
invokeTag('form','g',35,['url':([resource:productInstance, action:'save']),'enctype':("multipart/form-data")],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1397420083483L
