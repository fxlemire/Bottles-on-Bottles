...
class gsp_bottlesOnBottles_productedit_gsp extends GroovyPage {
...
invokeTag('form','g',38,['url':([resource:productInstance, action:'update']),'method':("PUT"),'enctype':("multipart/form-data")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1397420083484L
